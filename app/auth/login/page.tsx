  ...
  return (
    <div className="min-h-screen bg-bone flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 flex justify-between font-sans text-xs text-ink/40">
          <Link href="/auth/recuperar" className="hover:text-terracota transition-colors">
            ¿Olvidaste tu contraseña?
          </Link>
          <Link href="/auth/registro" className="hover:text-terracota transition-colors">
            Crear cuenta →
          </Link>
        </div>
      </div>
