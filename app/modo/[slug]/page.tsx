...
import { getAllModesWithPrices, getAllModeSlugs, getModeWithProducts } from "@/lib/db";
      ...
      <main>
        ...
        <section className="relative h-[85vh] min-h-[500px] overflow-hidden bg-ink">
          ...
          <div className="relative z-10 h-full flex flex-col justify-end pb-12 md:pb-16 px-6 md:px-16 max-w-7xl mx-auto">
            ...
            <FadeIn>
              <h1
                className="font-serif text-bone text-balance leading-tight tracking-tight mb-4"
            ...
            <FadeIn delay={0.2}>
              <p className="font-sans font-light text-bone/70 text-base md:text-lg max-w-xl leading-relaxed">
                {mode.tagline}
              </p>
            </FadeIn>
          </div>
        ...
        {/* Opening poem */}
        <section className="bg-bone py-20 md:py-32 px-6 md:px-16">
        ...
        {/* Continue watching */}
        {otherModes.length > 0 && (
          <section className="bg-fog py-20 md:py-32 px-6 md:px-12">
            <div className="max-w-7xl mx-auto">
