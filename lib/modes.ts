...
export const modes: Mode[] = [
  ...
  },
  {
    ...
    openingPoem:
      "Cafés de esquina, libros a medio leer, el arte de parecer que no te esforzaste. París no es un lugar — es una forma de moverse.",
    palette: ["#C8B99A", "#F2EDE4", "#4A4035", "#D4956A"],
    heroImage:
      "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=1600&q=80&fit=crop",
  ...
  },
  {
    ...
    openingPoem:
      "Luces bajas, conversaciones en susurros, un vestido que lo dice todo antes de que abras la boca. La noche merece sus propias reglas.",
